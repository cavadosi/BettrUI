  ...
  return (
    <Listbox value={selected} onChange={onChange} {...props}>
      ...
      <div className="relative mt-2">
        ...
        <ListboxOptions className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-background-light py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-hidden sm:text-sm dark:bg-background-dark dark:ring-gray-700">
          {items.map((item) => (
            <ListboxOption
              key={item.id}
              value={item}
