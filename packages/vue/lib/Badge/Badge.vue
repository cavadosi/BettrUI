...
const props = defineProps<{
  variant?: "primary" | "secondary" | "gray" | "red" | "yellow" | "green" | "blue" | "indigo" | "purple" | "pink";
...
<template>
  <span :class="twMerge(BadgeVariants({ variant: props.variant, rounded: props.rounded, border: props.border }))">
    <slot />
  </span>
</template>
